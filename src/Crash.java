...
public class Crash extends Thread {
	...
	public void run() {
		 ...
		 * game crashed in its normal coarse of operation and an error should be
		 * reported The if statement also checks if the user was pressing the cmd or alt
		 * key, if so they terminated the game out of coarse and a crash report should
		 * not be generated
		 */
		if (StateMachine.running && !StateMachine.render.exitKeyPushed) {
			/**
			 ...
			 * the error that caused the crash. Below is the creation of that panel. First
			 * we must remove the crashed screens and stop whatever is left of the game.
			 */
			...
			JLabel label = new JLabel("<html>An unhandled error has occured in your system: <br><br>" + errorMessage
					+ "<br><br> If you click 'Send' a report will be sent to the developers<br>detailing the problem so that they may attemt to fix it<br> If you hit 'Don't Send' the program will exit</html>");
	...
	private void sendEmail() {
		...
		final String to = "StellarGameMidwayBPA@gmail.com";
		final String from = "StellarGameMidwayBPA@gmail.com";
		final String username = "StellarGameMidwayBPA@gmail.com";
		final String password = "StellarGame2019";
